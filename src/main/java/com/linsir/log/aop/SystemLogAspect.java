package com.linsir.log.aop;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.linsir.log.annotation.OperationLog;
import com.linsir.log.bean.LogDTO;
import com.linsir.log.context.LogRecordContext;
import com.linsir.log.function.CustomFunctionRegistrar;
import com.linsir.log.service.IOperationLogGetService;
import com.linsir.log.service.IOperatorIdGetService;
import com.linsir.log.service.LogService;
import com.linsir.log.thread.LogRecordThreadPool;
...
/**
 * @author ：linsir
 * @date ：Created in 2022/9/12 18:01
 * @description：aop
 * @modified By：
 * @version: 0.0.1
 */
...
public class SystemLogAspect {
    ...
    @Around("@annotation(com.linsir.logRecord.annotation.OperationLog) || @annotation(com.linsir.logRecord.annotation.OperationLogs)")
